import 'package:al_quran_app/features/quran/domain/usecases/get_surah_from_json_usecase.dart';
...
class SurahCubit extends Cubit<SurahState> {
  final GetSurahFromJsonUseCase getSurahFromJsonUseCase =
      GetSurahFromJsonUseCase();
  SurahCubit() : super(SurahState(surahState: ViewData.initial()));

  void getSurah() async {
    emit(SurahState(surahState: ViewData.loading()));

    final result = await getSurahFromJsonUseCase.call(const NoParams());
